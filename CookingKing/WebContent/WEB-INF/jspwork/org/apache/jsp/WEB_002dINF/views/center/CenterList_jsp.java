 ...
 * Generated at: 2020-08-24 23:52:27 UTC
...
public final class CenterList_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (memberLoggedIn == null){ 
      ...
      out.write("<script>\r\n");
      out.write("\r\n");
      out.write("\tfunction gotoDetail(secretYn, writerId, csNo){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif(secretYn == \"Y\"){\r\n");
      out.write("\t\t\tif(");
      out.print(memberLoggedIn == null);
      out.write(") {    //비회원일 경우\r\n");
      out.write("\t\t\t\talert(\"본인만 확인 가능한 글입니다.\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
if(memberLoggedIn != null){
      out.write("\r\n");
      ...
      out.print(memberLoggedIn.getUserId());
      out.write("';\r\n");
      out.write("\t\t\tvar userComm = '");
      out.print(memberLoggedIn.getCommGrade());
      out.write("';\r\n");
}
      out.write("\r\n");
      out.write("\t\t\tif(userId != writerId && userComm != \"AD\") {    //작성자 본인이거나 관리자가 아닐 경우\r\n");
      out.write("\t\t\t\talert(\"본인만 확인 가능한 글입니다.\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/center/view?csNo=\" + csNo;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t$(function(){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#myCenter\").change(function(){              // 체크시 본인이 쓸글 제외 모두 감추기\r\n");
      out.write("\t\t\tvar flag = $(this).prop(\"checked\");\r\n");
      out.write("\t\t\tif(flag == true){\r\n");
      out.write("\t\t\t\t$.each($(\".userId-td\"), function(idx, item){\r\n");
      out.write("\t\t\t\t\tif($(item).text() != '");
      out.print( memberLoggedIn != null ? memberLoggedIn.getUserId() : "" );
      out.write("' && $(item).text() != 'admin'){\r\n");
      out.write("\t\t\t\t\t\t$(item).parent().slideUp();\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\telse {                                     // 체크해제시 모든글 보여주기\r\n");
      out.write("\t\t\t\t$(\".userId-td\").parent().slideDown();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t});\r\n");
      ...
      out.write("<!-- (예빈) 아래의 노란 줄은 div와 section의 위치가 꼬여서 그런 것이고 작동에는 문제 없으니 무시하셔도 됩니다. -->\r\n");
	...
	if(memberLoggedIn != null){
      ...
      out.write("\r\n");
      out.write("\t<div class=\"mm-search-wrapper\">\r\n");
      out.write("\t<input type=\"button\" value=\"글 작성하기\" id=\"btn-add\"\r\n");
      out.write("\t\t\tonclick=\"location.href='");
      out.print(request.getContextPath());
      out.write("/center/insert';\" />\r\n");
      out.write("\t<input type=\"checkbox\" name=\"myCenter\" id=\"myCenter\"/>\r\n");
      out.write("\t<label for=\"myCenter\" id=\"myCenter\">내가 작성한 글만 보기</label>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("<div class=\"cs-tbl-wrapper\">\r\n");
      out.write("\t<table id =\"cs-center-list\">\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>번호</th>\r\n");
      out.write("\t\t\t<th>제목</th>\r\n");
      out.write("\t\t\t<th>작성자</th>\r\n");
	...
	if(list == null || list.isEmpty()){
      ...
      out.write("\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th colspan=\"6\">조회된 문의 사항이 없습니다</th>\r\n");
      out.write("\t\t</tr>\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t<!-- (예빈) 관리자가 작성한 글은 모든 td의 배경색을 회색으로 처리, \r\n");
      out.write("\t\t\t      추가로 비밀글로 작성된 글은 글 제목을 회색으로 표시하도록 변경한다. -->\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t \t<td\r\n");
      out.write("\t\t \t");
 if(b.getUserId().equals("admin")) { 
      out.write("\r\n");
      out.write("\t\t\tstyle='background: #e8ecf1'\r\n");
      out.write("\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t \t> ");
      out.print( b.getUserId().equals("admin") ? "공지" : b.getCsNo() );
      out.write(" </td>\r\n");
      out.write("\t\t \t\r\n");
      out.write("\t\t\t<td \r\n");
      out.write("\t\t\t");
 if(b.getUserId().equals("admin")) { 
      ...
      out.write(");\">\r\n");
      out.write("\t\t\t\t");
      out.print( b.getCsSecretYN().equals("Y") ? "--- 비밀 설정된 글 입니다. ---" : b.getCsTitle() );
      out.write("\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<td \r\n");
