 ...
 * Generated at: 2020-08-24 20:06:11 UTC
...
public final class CenterView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(memberLoggedIn != null && memberLoggedIn.getCommGrade().equals("AD")){ 
      ...
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"공지 내리기\" onclick=\"cancelNotice(");
      out.print( b.getCsNo() );
      out.write(");\" />\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
	...
	for(CenterComment bc : commentList){
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function cancelNotice(csNo){\r\n");
      out.write("\tlocation.href = '");
      out.print( request.getContextPath() );
      out.write("/center/notice/cancel?csNo='+csNo;\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<!DOCTYPE html>\r\n");
