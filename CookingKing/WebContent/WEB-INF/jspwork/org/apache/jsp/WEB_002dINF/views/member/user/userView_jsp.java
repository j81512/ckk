 ...
 * Generated at: 2020-08-24 09:52:28 UTC
...
User u = (User)session.getAttribute("memberLoggedIn");
 ...
 if (memberLoggedIn == null){ 
      ...
      out.write("\r\n");
      out.write("<body>\r\n");
      out.write("<div class=\"wrapper-user-view\">\r\n");
      out.write("\t\t<div class=\"user-notice1\">\r\n");
      out.write("            <form id=\"user-frm\">\r\n");
      out.write("                <p class=\"notice-p\">회원 정보 수정</p>\r\n");
      out.write("                    <div class=\"modi-inner\">\r\n");
      out.write("\t\t\t<div class=\"user\" id=\"user-input1\">\r\n");
      out.write("\t\t\t\t<label for=\"userId\" id=\"register-id\">아이디 : </label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"userId\" id=\"userId\" value=\"");
      out.print( u.getUserId() );
      out.write("\" readonly/>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<br />\r\n");
      out.write("\t\t\t<div class=\"user\" id=\"user-input2\">\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<br />\r\n");
      out.write("\t\t\t<div class=\"user\" id=\"user-input3\">\r\n");
      out.write("\t\t\t\t<label for=\"gender\">성별 : </label>\r\n");
      out.write("\t\t\t\t<select name=\"gender\" id=\"gender\">\r\n");
      out.write("\t\t\t\t\t<option value=\"M\" ");
      out.print( "M".equals(u.getGender()) ? "selected" : "" );
      out.write(">남</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"F\" ");
      out.print( "F".equals(u.getGender()) ? "selected" : "" );
      out.write(">여</option>\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<br />\r\n");
      out.write("\t\t\t<div class=\"user\" id=\"user-input4\">\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<br />\r\n");
      out.write("\t\t\t<div class=\"user\" id=\"user-input5\">\r\n");
      out.write("\t\t\t\t<label for=\"birthday\">생일 : </label>\r\n");
      out.write("\t\t\t\t<input type=\"date\" name=\"birthday\" id=\"birthday\" value=\"");
      out.print( u.getBirthday() );
      out.write("\" required/>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<br />\r\n");
      out.write("\t\t\t<div class=\"user\" id=\"user-input6\">\r\n");
      ...
      out.write("\t\t\t<br />\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"modi-inner-btn\">\r\n");
      out.write("\t\t\t<input type=\"button\" class=\"modi-btn1\" value=\"정보 수정\" onclick=\"updateUser();\" />\r\n");
      out.write("\t\t\t<input type=\"button\" class=\"modi-btn2\" value=\"회원 탈퇴\" onclick=\"deletUser();\" />\r\n");
      out.write("            <input type=\"button\" class=\"modi-btn3\" value=\"비밀번호 수정\" onclick=\"updatePassword();\"/>\r\n");
      out.write("        </div>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("\t<!-- 회원탈퇴용폼 : 아이디 제출용 -->\r\n");
      out.write("\t<form id=\"deleteUserFrm\" action=\"");
      out.print(request.getContextPath());
      out.write("/user/delete\" method=\"post\">\r\n");
      ...
      out.write("\t//제출 전에 유효성 검사 필요합니다. - 시작\r\n");
      out.write("\t\t//2. 이메일 유효성 검사 -> /^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z]*.[a-zA-z]{2,3})$/i\r\n");
      out.write("\t\tvar email = document.getElementById(\"email\");\r\n");
      out.write("\t\tif((/^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z]*.[a-zA-z]{2,3})$/i).test(email.value) == false){\r\n");
      out.write("\t\t\talert(\"유효한 이메일 주소를 입력해주세요!\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t\temail.select();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//3. 휴대폰 번호 유효성 검사 -> /^01(?:0|1|[6-9])([0-9]{3}|[0-9]{4})([0-9]{4})$/\r\n");
      out.write("\t\tvar phone = document.getElementById(\"phone\");\r\n");
      out.write("\t\tif((/^01(?:0|1|[6-9])([0-9]{3}|[0-9]{4})([0-9]{4})$/).test(phone.value) == false) {\r\n");
      out.write("\t\t\talert(\"유효한 핸드폰 번호를 입력해주세요!\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t\tphone.select();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//4. 주소 유효성 검사\r\n");
      out.write("\t\tvar address = document.getElementById(\"address\");\r\n");
      out.write("\t\tif((/[가-힣]{1,}/).test(address.value) == false){\r\n");
      out.write("\t\t\talert(\"유효한 주소를 입력해 주세요!\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t\taddress.select();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t//유효성 검사 - 끝\r\n");
      out.write("\tvar userFrm = document.getElementById(\"user-Frm\");\r\n");
      out.write("\t//console.log(userFrm);\r\n");
      out.write("\tuserFrm.setAttribute(\"action\", \"");
      out.print( request.getContextPath() );
      out.write("/user/update\");\r\n");
      out.write("\tuserFrm.setAttribute(\"method\", \"POST\");\r\n");
      out.write("\tuserFrm.submit();\r\n");
      out.write("\t\r\n");
      out.write("};\r\n");
      out.write("\r\n");
      out.write("//회원 삭제\r\n");
      out.write("function deletUser(){\r\n");
      out.write("\t//삭제 여부 확인\r\n");
      out.write("\tif(confirm(\"정말로 탈퇴하시겠습니까?\")){\r\n");
      out.write("\t\tvar delFrm = document.getElementById(\"deleteUserFrm\");\r\n");
      out.write("\t\tdelFrm.submit();\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("};\r\n");
      out.write("\r\n");
      out.write("//비밀번호 변경 -> get방식으로 진행\r\n");
      out.write("//버튼 클릭 시 세션에 로그인 되어있는 Id값을 가지고 비밀번호 변경 페이지로 우회 후 진행\r\n");
      out.write("function updatePassword(){\r\n");
      out.write("\t\r\n");
      out.write("\tlocation.href = \"");
      out.print( request.getContextPath() );
      out.write("/user/updatePassword?userId=");
      out.print(u.getUserId());
      out.write("\";\r\n");
      out.write("\t\r\n");
      out.write("};\r\n");
