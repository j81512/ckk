 ...
 * Generated at: 2020-08-24 23:47:10 UTC
...
public final class boardUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (memberLoggedIn == null){ 
	...
	Board b = (Board)request.getAttribute("board");
      ...
      out.write("\t}\r\n");
      out.write("\t.file-label:hover, .hidden-label:hover{\r\n");
      ...
      out.write("<script>\r\n");
      out.write("$(function(){\r\n");
      out.write("\t$(\".numberInput\").keypress(function(event){\r\n");
      ...
      out.write("\tvar regExp = /^.{1,14}$/;\r\n");
      out.write("\tif(regExp.test($(\"#title\").val()) == false){\r\n");
      out.write("\t\talert(\"제목은 공백포함 14글자 이하로 설정 가능합니다.\");\r\n");
      ...
      out.write("<link rel=\"stylesheet\" href=\"");
      out.print(request.getContextPath() );
      out.write("/css/board-insert.css\" />\r\n");
      out.write("<div class=\"view-div\">\r\n");
      out.write("<form action=\"");
      out.print( request.getContextPath() );
      out.write("/board/update\" method=\"POST\" enctype=\"multipart/form-data\" onsubmit=\"return check();\">\r\n");
      out.write("<section id=\"ins-cont-wrapper\">\r\n");
      out.write("<div class=\"page-title\">\r\n");
      out.write("\t<p class=\"page-title-p\">클래스 수정</p>\r\n");
      out.write("</div>\r\n");
      out.write("\t<label for=\"ins-title\">제목</label>\r\n");
      out.write("\t<input type=\"text\" name=\"ins-title\" id=\"ins-title\" required value=\"");
      out.print( b.getTitle() );
      out.write("\"/>\r\n");
      out.write("\t<div class=\"ins-cont\">\t\r\n");
      out.write("\t<!-- <label for=\"classContent\">내용</label> -->\r\n");
      out.write("\t<textarea name=\"classContent\" id=\"classContent\" cols=\"30\" rows=\"10\" \r\n");
      out.write("\tplaceholder=\"\r\n");
      out.write("\t부득이 일정한 내용의 게시물은 게재가 제한될 수 있습니다.\r\n");
      out.write("\t\r\n");
      out.write("\t여러분의 다양한 생각이나 경험 또는 의견이 담긴 게시물은 \r\n");
      out.write("\t최대한 게재가 유지되어 다른 이용자들에게 전파될 것입니다. \r\n");
      out.write("\t다만 여러분이 쿠킹킹을 보다 안전하게 이용할 수 있도록, \r\n");
      out.write("\t쿠킹킹에서 여러분과 타인의 권리가 서로 존중되고 보호받을 수 있도록, \r\n");
      out.write("\t그리고 쿠킹킹이 신뢰 있는 서비스로서 안정적으로 제공될 수 있도록 \r\n");
      out.write("\t부득이 아래와 같은 경우 여러분의 게시물 게재가 제한될 수 있으므로, \r\n");
      out.write("\t이에 대한 확인 및 준수를 요청 드립니다.\"\r\n");
      out.write("\trequired>");
      out.print( b.getClassContent() );
      out.write("</textarea>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</section>\r\n");
      out.write("\t\r\n");
      out.write("\t<section id=\"ins-input-wrapper\">\r\n");
      out.write("<div class=\"ins-input-inner\">\r\n");
      out.write("<p id=\"ins-input-title\">클래스 상세 정보를 설정해 주세요.</p>\r\n");
      out.write("<section id=\"ins-input-in-inner\">\r\n");
      out.write("<div class=\"ins-info1\">\r\n");
      out.write("\t<label for=\"price\">가격</label>\r\n");
      out.write("\t<input type=\"text\" name=\"price\" id=\"price\" class=\"numberInput\" required value=\"");
      out.print( b.getPrice() );
      out.write("\"/>\r\n");
      out.write("\t<label for=\"classDate\">일시</label> <!-- 지원 마감일 최대기한 3일 이후 부터 한달 -->\r\n");
      out.write("\t<input type=\"date\" name=\"classDate\" id=\"classDate\" min=\"");
      out.print( sdf.format(classDateS.getTime()) );
      out.write("\" max=\"");
      out.print( sdf.format(classDateE.getTime()) );
      out.write("\" required value=\"");
      out.print( b.getClassDate() );
      out.write("\"/>\r\n");
      out.write("\t<br />\r\n");
      out.write("\t<label for=\"startTime\">시작</label>\r\n");
      out.write("\t<select name=\"startTime\" id=\"startTime\" required>\r\n");
      out.write("\t\t<option value=\"\" selected disabled>~시 부터</option>\r\n");
      out.write("\t");
 for(int i = 0; i < 24; i++){ 
      out.write("\r\n");
      ...
      out.write('"');
      out.write(' ');
      out.print( b.getStartTime() == i ? "selected" : "" );
      out.write('>');
      out.print( i );
      out.write("시</option>\r\n");
      out.write("\t");
      ...
      out.write("\r\n");
      out.write("\t</select>\r\n");
      out.write("\t<label for=\"endTime\">종료</label>\r\n");
      out.write("\t<select name=\"endTime\" id=\"endTime\" required>\r\n");
      out.write("\t\t<option value=\"\" selected disabled>~시 까지</option>\r\n");
      out.write("\t");
 for(int i = 0; i < 24; i++){ 
      out.write("\r\n");
      out.write("\t\t<option value=\"");
      ...
      out.write('"');
      out.write(' ');
      out.print( b.getEndTime() == i ? "selected" : "" );
      out.write('>');
      out.print( i );
      out.write("시</option>\r\n");
      out.write("\t");
      ...
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div class=\"ins-info3\">\t\r\n");
      out.write("\t<label for=\"category\">분야</label>\r\n");
      out.write("\t<select name=\"category\" id=\"category\" required>\r\n");
      out.write("\t\t<option value=\"\" disabled>카테고리</option>\r\n");
      out.write("\t\t<option value=\"MD\" ");
      out.print( b.getCategory().equals("MD") ? "selected" : "" );
      out.write(">Main Dish</option>\r\n");
      out.write("\t\t<option value=\"DS\" ");
      out.print( b.getCategory().equals("DS") ? "selected" : "" );
      out.write(">Dessert</option>\r\n");
      out.write("\t\t<option value=\"DR\" ");
      out.print( b.getCategory().equals("DR") ? "selected" : "" );
      out.write(">Drink</option>\r\n");
      out.write("\t\t<option value=\"AL\" ");
      out.print( b.getCategory().equals("AL") ? "selected" : "" );
      out.write(">Liquor</option>\r\n");
      out.write("\t</select>\r\n");
      out.write("\t\r\n");
      out.write("\t<label for=\"classLocation\">지역</label>\r\n");
      out.write("\t<select name=\"classLocation\" id=\"classLocation\" required>\r\n");
      out.write("\t\t<option value=\"\" disabled>지역</option>\r\n");
      out.write("\t\t<option value=\"NORTH\" ");
      out.print( b.getClassLocation().equals("NORTH") ? "selected" : "" );
      out.write(">강북구</option>\r\n");
      out.write("\t\t<option value=\"SOUTH\" ");
      out.print( b.getClassLocation().equals("SOUTH") ? "selected" : "" );
      out.write(">강남구</option>\r\n");
      out.write("\t\t<option value=\"EAST\" ");
      out.print( b.getClassLocation().equals("EAST") ? "selected" : "" );
      out.write(">강동구</option>\r\n");
      out.write("\t\t<option value=\"WEST\" ");
      out.print( b.getClassLocation().equals("WEST") ? "selected" : "" );
      out.write(">강서구</option>\r\n");
      out.write("\t</select>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div class=\"ins-info4\">\r\n");
      out.write("\t<label for=\"classAddress\">주소</label>\r\n");
      out.write("\t<input type=\"text\" name=\"classAddress\" id=\"classAddress\" required value=\"");
      out.print( b.getClassAddress() );
      out.write("\"/>\r\n");
      out.write("\t<br />\r\n");
      out.write("\t<label for=\"capacity\">인원</label>\r\n");
      out.write("\t<input type=\"text\" name=\"capacity\" id=\"capacity\" class=\"numberInput\" required value=\"");
      out.print( b.getCapacity() );
      out.write("\"/>\r\n");
      out.write("\t<label for=\"lastApplyDate\">지원 마감일</label> <!-- 게시글 등록 날짜로부터 한달 -->\r\n");
      out.write("\t<input type=\"date\" name=\"lastApplyDate\" id=\"lastApplyDate\" min=\"");
      out.print( sdf.format(today.getTime()) );
      out.write("\" max=\"");
      out.print( sdf.format(lastApply.getTime()) );
      out.write("\" required value=\"");
      out.print( b.getLastApplyDate() );
      out.write("\"/>\r\n");
      out.write("\t<br />\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div class=\"bu\">\r\n");
      out.write("\t<table id=\"bu-tbl\">\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>사진</th>\r\n");
      out.write("\t\t\t<th>수정</th>\r\n");
      out.write("\t\t\t<th>삭제</th>\r\n");
      ...
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<span>");
      out.print( b.getClassPic1Org() );
      out.write("</span>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<input class=\"file-input\" type=\"file\" name=\"pic1-input\" id=\"pic1-input\" style=\"opacity: 0; position: absolute; width: 0px;\"/>\r\n");
      out.write("\t\t\t\t<label class=\"hidden-label\" style=\"display: none;\"></label>\r\n");
      out.write("\t\t\t\t<label class=\"file-label\" for=\"changePic1\">파일 변경</label>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<label>삭제 불가</label>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<span>");
      out.print( b.getClassPic2Org() != null ? b.getClassPic2Org() : "업로드한 파일이 없습니다." );
      out.write("</span>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<input class=\"file-input\" type=\"file\" name=\"pic2-input\" id=\"pic2-input\" style=\"opacity: 0; position: absolute; width: 0px;\"/>\r\n");
      out.write("\t\t\t\t<label class=\"hidden-label\" style=\"display: none;\"></label>\r\n");
      out.write("\t\t\t\t<label class=\"file-label\" for=\"changePic2\">");
      out.print( b.getClassPic2Org() != null ? "파일 변경" : "파일 업로드" );
      out.write("</label>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<label for=\"del-pic2\">삭제하기</label>\r\n");
      out.write("\t\t\t\t<input type=\"checkbox\" name=\"del-pic2\" id=\"del-pic2\" ");
      out.print( b.getClassPic2Org() != null ? "" : "disabled" );
      out.write("/>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<span>");
      out.print( b.getClassPic3Org() != null ? b.getClassPic3Org() : "업로드한 파일이 없습니다." );
      out.write("</span>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<input class=\"file-input\" type=\"file\" name=\"pic3-input\" id=\"pic3-input\" style=\"opacity: 0; position: absolute; width: 0px;\"/>\r\n");
      out.write("\t\t\t\t<label class=\"hidden-label\" style=\"display: none;\"></label>\r\n");
      out.write("\t\t\t\t<label class=\"file-label\" for=\"changePic2\">");
      out.print( b.getClassPic3Org() != null ? "파일 변경" : "파일 업로드" );
      out.write("</label>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<label for=\"del-pic3\">삭제하기</label>\r\n");
      out.write("\t\t\t\t<input type=\"checkbox\" name=\"del-pic3\" id=\"del-pic3\" ");
      out.print( b.getClassPic3Org() != null ? "" : "disabled" );
      out.write("/>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t</table>\r\n");
      ...
      out.write("</div>\r\n");
      out.write("</section>\r\n");
      out.write("<div class=\"ins-apply\">\r\n");
      out.write("\t<input type=\"hidden\" name=\"classNo\" value=\"");
      out.print( b.getClassNo() );
      out.write("\" />\r\n");
      out.write("\r\n");
      out.write("\t<input type=\"submit\" value=\"수정하기\" id=\"ins-submit2\"/>\r\n");
