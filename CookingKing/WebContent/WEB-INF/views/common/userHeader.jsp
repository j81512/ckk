...
/*         function lostPw(){
        ...
        function msg(){
        	...
        	var status = "left= 300px, top=50px, width=1000px, height=700;";
        	open(url, title, status);
        };
    </script>
    <style>
  ...
  <% } else if (memberLoggedIn != null && !memberLoggedIn.getCommGrade().equals(adminGrade)){ %>
      ...
      <div class="mypage-loggedIn" id="mypage-loggedIn">
        ...
        <div class="mypage" id="mypage">
            ...
            <button class="mypages" id="write-resume" onclick="<%="P".equals(memberLoggedIn.getResumeYNP()) ? "alert('이력서심사가 진행중입니다.')" : "location.href='" +request.getContextPath()+ "/tutor/writerResume.do?userId=" +memberLoggedIn.getUserId()+"'" %>">이력서 관리</button><br />
